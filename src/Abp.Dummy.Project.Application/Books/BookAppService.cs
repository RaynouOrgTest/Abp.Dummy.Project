...
using MiniExcelLibs;
using Abp.Dummy.Project.Authors;
using Abp.Dummy.Project.Permissions;
...
[Authorize(ProjectPermissions.Books.Default)]
public class BookAppService : ApplicationService, IBookAppService
{
    ...
    [Authorize(ProjectPermissions.Books.Create)]
    ...
    [Authorize(ProjectPermissions.Books.Edit)]
    ...
    [Authorize(ProjectPermissions.Books.Delete)]
